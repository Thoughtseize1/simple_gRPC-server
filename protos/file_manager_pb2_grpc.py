...
import file_manager_pb2 as file__manager__pb2
...
class FileExchangerStub(object):
...
class FileExchangerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FileExchangerServicer_to_server(servicer, server):
    rpc_method_handlers = {
